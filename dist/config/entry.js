import path from'path';import{searchEntries,searchDirs,fsExistsSync,isArray,isPlugin,isBundle,isTheme,isActivity}from'../utils';import options from'./options';// 设置别名
